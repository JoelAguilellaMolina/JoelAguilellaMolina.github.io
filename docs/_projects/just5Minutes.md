...
Just 5 Minutes es un videojuego desarrollado en 4 días en un equipo de 6 personas para la Game Jam de [Game Maker's Toolkit 2026](https://itch.io/jam/gmtk-jam-2026). En este proyecto he trabajado como principal diseñador de gameplay y dirección narrativa de éste, siendo el creador de la idea principal de gameplay a partir de la temática de la jam que se propuso para el desarrollo: **Countdown**.
...
![Just5Miniconosheet](/assets/images/iconosheetJust5Minutes.png)
